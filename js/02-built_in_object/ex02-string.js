...
const txt='ABCDEFGHIJKIMNOPQRSTUVWXYZ';
...
console.log(str.indexOf('ello',6)); //'ello'를 6번째 인덱스부터 검색합니다.

//문자열 자르기 (substring,slice)//substr은 deprecated
str='Apple, Banana, Kiwi';
console.log(str.slice(7,13));
console.log(str.slice(7));
console.log(str.slice(-12)); //js 음수 인덱스 지원 안함 slice에서만 사용가능
...
console.log(strPad.padEnd(6,0));

//문자, 문자코드
const strChar='HELLO WORLD';
console.log(strChar.charAt(6)); //문자하나
console.log(strChar.charCodeAt(6)); // 문자코드
...
//문자열 시작/끝 확인(startWith,endsWith)
